...
const Watch = () => {
    ...
    const like = async (userId, mediaId) => {
        try {
            await axios.put(
                `/media/${mediaId}/like`,
                {
    ...
    const dislike = async (userId, mediaId) => {
        try {
            await axios.put(
                    ...
                    <div className="col-12 col-md-8 p-4">
                        ...
                        >
                            {!isFavorite ? (
                                ...
                                <div className="btn btn-danger" onClick={favoriteToggle}>
                                    <i className="fa fa-heart"></i> Remove from Favorites
                                </div>
                            )}

                            <div className="btn btn-outline-primary mx-2" data-bs-toggle="modal" data-bs-target="#addToPlaylistModal">
                    ...
                    <div className="col-12 col-md-4">
                        ...
                        >
                            ...
                            <div>
                                ...
                                <div className="btn btn-success mx-1" onClick={downloadMedia}>
